...
forktest(void)
{
  ...
  3e:	3fe50513          	add	a0,a0,1022 # 438 <trace+0xe>
  ...
  68:	3e450513          	add	a0,a0,996 # 448 <trace+0x1e>
  ...
  b8:	3e450513          	add	a0,a0,996 # 498 <trace+0x6e>
  ...
  d4:	39850513          	add	a0,a0,920 # 468 <trace+0x3e>
  ...
  ee:	39650513          	add	a0,a0,918 # 480 <trace+0x56>
...
memset(void *dst, int c, uint n)
{
 ...
 198:	87aa                	mv	a5,a0
 19a:	1602                	sll	a2,a2,0x20
 19c:	9201                	srl	a2,a2,0x20
